...
class LaravelCybersource
{
    ...
    public function generateFormData(array $paymentData): array
    {
        ...
        $data = [
            ...
            'payment_method' => "card",
            'bill_to_forename' => $paymentData['bill_to_forename'] ?? 'Forename',
            'bill_to_surname' => $paymentData['bill_to_surname'] ?? 'Surname',
            'bill_to_email' => $paymentData['bill_to_email'] ?? 'demo@gmail.com',
            'bill_to_phone' => $paymentData['bill_to_phone'] ?? '9800000000',
            'bill_to_address_line1' => $paymentData['bill_to_address_line1'] ?? 'N/A',
            'bill_to_address_city' => $paymentData['bill_to_address_city'] ?? 'Kathamndu',
            'bill_to_address_state' => $paymentData['bill_to_address_state'] ?? 'Province1',
            'bill_to_address_country' => $paymentData['bill_to_address_country'] ?? 'NP',
            'bill_to_address_postal_code' => $paymentData['bill_to_address_postal_code'] ?? '46600',
            'card_type' => '001',
            'card_number' => '',
            'card_expiry_date' => '',
            'auth_trans_ref_no' => ''
