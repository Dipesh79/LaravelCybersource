...
class LaravelCybersource
{
    ...
    public function generateFormData(array $paymentData): array
    {
        ...
        $data = [
            ...
            'payment_method' => "card",
            'bill_to_forename' => $paymentData['bill_to_forename'] ?? null,
            'bill_to_surname' => $paymentData['bill_to_surname'] ?? null,
            'bill_to_email' => $paymentData['bill_to_email'] ?? null,
            'bill_to_phone' => $paymentData['bill_to_phone'] ?? null,
            'bill_to_address_line1' => $paymentData['bill_to_address_line1'] ?? null,
            'bill_to_address_city' => $paymentData['bill_to_address_city'] ?? null,
            'bill_to_address_state' => $paymentData['bill_to_address_state'] ?? null,
            'bill_to_address_country' => $paymentData['bill_to_address_country'] ?? null,
            'bill_to_address_postal_code' => $paymentData['bill_to_address_postal_code'] ?? null,
            'card_type' => '001',
            'card_number' => '',
            'card_expiry_date' => '',
            'auth_trans_ref_no' => ''
